<div class="main-content">
        ...
        <!-- Modal with form -->
        <div class="modal fade" id="tambahKriteria" tabindex="-1" role="dialog" aria-labelledby="formModal"
          aria-hidden="true">
		...
		<!-- Modal with form -->
        <div class="modal fade" id="lihatKriteria" tabindex="-1" role="dialog" aria-labelledby="formModal"
          aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
