        ...
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html"> <img alt="image" src="assets/img/logo.png" class="header-logo" /> <span
                class="logo-name">PKH</span>
            </a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Main</li>
            <li class="dropdown active <?php echo ($this->uri->segment(1) == '') ? 'active' : '' ?>">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="nav-link" href="<?php echo base_url() ?>penerima_bantuan">Data Penerima Bantuan</a></li>
                <li><a class="nav-link" href="<?php echo base_url() ?>Kriteria_bobot">Data Kriteria dan Bobot</a></li>
              </ul>
            </li>
            <li class="dropdown">
